...
import 'package:flutter_map/flutter_map.dart' hide FadeRAWA;

import 'CustomAttributionAnimation.dart';
...
/// {@endtemplate}
@immutable
class CustomAttributionWidget extends StatefulWidget {
  ...
  ///
  final CustomAttributionWidgetAnimation animationConfig;
  ...
  @override
  State<CustomAttributionWidget> createState() => _CustomAttributionWidgetState();
}

class _CustomAttributionWidgetState extends State<CustomAttributionWidget> {
                ...
                child: DecoratedBox(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: (widget.permanentHeight - 16)),
                        ...widget.attributions
