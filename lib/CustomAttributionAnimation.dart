...
@immutable
abstract interface class CustomAttributionWidgetAnimation {
  ...
  Widget popupAnimationBuilder({
    ...
    required CustomAttributionWidget config,
...
@immutable
class ScaleRAWA implements CustomAttributionWidgetAnimation {
  /// The duration of the animation used when toggling the state of the
  /// open/close button
  ///
  /// The same duration is used between all three states, as described in
...
/// curves, as well as the open/close button's.
@immutable
class FadeRAWA implements CustomAttributionWidgetAnimation {
  /// The duration of the animation used when toggling the state of the
  /// open/close button
  ///
  /// The same duration is used between all three states, as described in
